...
class PagePopupMenu extends TextComponentPopupMenu {
	...
	PagePopupMenu(Page p) {
		...
		JMenuItem menuItem = new JMenuItem(page.getAction(Resource.get("FontDialog_java_ziti")));
		String s = Modeler.getInternationalText(Resource.get("FontDialog_java_ziti"));
	...
	public void show(Component invoker, int x, int y) {
		...
		page.getAction(Resource.get("FontDialog_java_ziti")).setEnabled(b);
