...
class FontDialog extends JDialog {
	...
	FontDialog(final Page page) {
		...
		super(JOptionPane.getFrameForComponent(page), Resource.get("FontDialog_java_ziti"), true);
		...
		s = Modeler.getInternationalText(Resource.get("FontDialog_java_jiacu"));
		checkBoxBold = new JCheckBox(s != null ? s : Resource.get("FontDialog_java_jiacu"));
		p.add(checkBoxBold);

		s = Modeler.getInternationalText(Resource.get("FontDialog_java_xieti"));
		checkBoxItalic = new JCheckBox(s != null ? s : Resource.get("FontDialog_java_xieti"));
		p.add(checkBoxItalic);

		s = Modeler.getInternationalText(Resource.get("FontDialog_java_xiahuaxian"));
		checkBoxUnderline = new JCheckBox(s != null ? s : Resource.get("FontDialog_java_xiahuaxian"));
