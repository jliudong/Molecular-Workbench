...
class ColorBarPopupMenu extends JPopupMenu {
	...
	ColorBarPopupMenu(Page p) {
		...
		String s = Modeler.getInternationalText(Resource.get("Editor_java_kaobei"));
		miCopy = new JMenuItem(s != null ? s : Resource.get("Editor_java_kaobei"));
		...
		s = Modeler.getInternationalText(Resource.get("Editor_java_jianqie"));
		miCut = new JMenuItem(s != null ? s : Resource.get("Editor_java_jianqie"));
