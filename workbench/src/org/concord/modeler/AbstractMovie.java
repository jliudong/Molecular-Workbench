...
public abstract class AbstractMovie implements Movie {
	...
	private void createActions() {
		...
		rewindMovie = new DefaultAction() {
			public void actionPerformed(ActionEvent e) {
				enableMovieActions(false);
				new SwingWorker(Resource.get("AbstractMovie_java_huifang")) {
					public Object construct() {
		...
		rewindMovie.putValue(SHORT_DESCRIPTION, Resource.get("AbstractMovie_java_huifang"));
		...
		stepForwardMovie.putValue(SHORT_DESCRIPTION, Resource.get("AbstractMovie_java_shangyigeshipin"));
		...
		stepBackMovie.putValue(SHORT_DESCRIPTION, Resource.get("AbstractMovie_java_shangyiji"));
	...
	void changeToolTipText() {
		if (runAction != null) {
			if (frameIndex < length() - 1) {
				...
				runAction.putValue(Action.SHORT_DESCRIPTION, Resource.get("AbstractMovie_java_qidongmoxing"));
			}
		}
	}
