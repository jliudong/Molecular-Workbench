...
class SnapshotEditor extends JPanel implements DrawListener {
	...
	SnapshotEditor(SnapshotGallery g) {
		...
		button.setToolTipText(Resource.get("SnapshotEditor_java_tianjiawenzikuang"));
		if (!Modeler.isMac())
			button.setMargin(margin);
		...
		button.setToolTipText(Resource.get("UserAction_java_jiafangkuang"));
		if (!Modeler.isMac())
			button.setMargin(margin);
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		button = new JButton(IconPool.getIcon(Resource.get("Editor_java_jianqie")));
		...
		button = new JButton(IconPool.getIcon(Resource.get("Editor_java_kaobei")));
		...
		button = new JButton(IconPool.getIcon(Resource.get("Editor_java_zhantie")));
		button.setToolTipText(Resource.get("Editor_java_zhantie"));
		if (!Modeler.isMac())
			button.setMargin(margin);
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
