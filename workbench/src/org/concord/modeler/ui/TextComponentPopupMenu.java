...
public class TextComponentPopupMenu extends JPopupMenu {
	...
	public TextComponentPopupMenu(JTextComponent t) {
		...
		String s = getInternationalText(Resource.get("Editor_java_kaobei"));
		miCopy.setText(s == null ? Resource.get("Editor_java_kaobei") : s);
		miCopy.setIcon(IconPool.getIcon(Resource.get("Editor_java_kaobei")));
		...
		miCut.setText(s == null ? Resource.get("Editor_java_jianqie") : s);
		miCut.setIcon(IconPool.getIcon(Resource.get("Editor_java_jianqie")));
		...
		miPaste.setText(s == null ? Resource.get("Editor_java_zhantie") : s);
		miPaste.setIcon(IconPool.getIcon(Resource.get("Editor_java_zhantie")));
