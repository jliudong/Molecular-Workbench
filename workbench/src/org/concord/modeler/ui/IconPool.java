...
public final class IconPool {
	...
	private static void init() {
		...
		map.put(Resource.get("Editor_java_jianqie"), icon);

		icon = new ImageIcon(c.getResource("images/copy.gif"));
		map.put(Resource.get("Editor_java_kaobei"), icon);

		icon = new ImageIcon(c.getResource("images/paste.gif"));
		map.put(Resource.get("Editor_java_zhantie"), icon);
		...
		map.put(Resource.get("Page_java_chexiao"), icon);

		icon = new ImageIcon(c.getResource("images/redo.gif"));
		map.put(Resource.get("Page_java_chongzuo"), icon);
