...
public class FontChooser extends JComponent {
	...
	public FontChooser() {
		...
		p.setBorder(new TitledBorder(BorderFactory.createEtchedBorder(), Resource.get("FontDialog_java_ziti"), 0, 0,
		...
		p.setBorder(new TitledBorder(BorderFactory.createEtchedBorder(), "Effects", 0, 0, new Font("Arial", Font.PLAIN,
				11), Color.black));
		checkBoxBold = new JCheckBox(Resource.get("FontDialog_java_jiacu"));
		checkBoxBold.setFont(font);
		p.add(checkBoxBold);
		checkBoxItalic = new JCheckBox(Resource.get("FontDialog_java_xieti"));
		checkBoxItalic.setFont(font);
		p.add(checkBoxItalic);

		checkBoxUnderline = new JCheckBox(Resource.get("FontDialog_java_xiahuaxian"));
