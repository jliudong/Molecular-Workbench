...
public class Modeler extends JFrame implements BookmarkListener, EditorListener, DownloadListener, PageListener {
	...
	private final static String REMOTE_STATIC_ROOT = "http://223.4.82.92/public/";
	private final static String LOCAL_STATIC_ROOT = "http://localhost/public/";
	private final static String REMOTE_CONTEXT_ROOT = "http://localhost:8080/";
	...
	void createMenuBar() {
		...
		menuItem.setToolTipText(Resource.get("Modeler_java_lingcunwei")+"applet");
		menu.add(menuItem);

		compressPageMI.setToolTipText(Resource.get("Modeler_java_yasuobenye"));
		...
		compressFolderMI.setToolTipText(Resource.get("Modeler_java_yasuosuoyou"));
		...
		menuItem.setText((s != null ? s : Resource.get("Editor_java_guankankuaizhao")) + "...");
		menu.add(menuItem);

		s = getInternationalText("ViewSessionLog");
		menuItem = new JMenuItem((s != null ? s : "View Session Log") + "...");
		menuItem.setMnemonic(KeyEvent.VK_I);
		menuItem.setToolTipText(Resource.get("Modeler_java_shiyongjilu"));
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		cutMI.setText(s != null ? s : Resource.get("Editor_java_jianqie"));
		...
		copyMI.setText(s != null ? s : Resource.get("Editor_java_kaobei"));
		...
		menuItem.setText(s != null ? s : Resource.get("Editor_java_zhantie"));
		menuItem.setMnemonic(KeyEvent.VK_P);
		...
		menuItem = new JMenuItem(page.getAction(Resource.get("Page_java_zhantiechunwenben")));
		s = getInternationalText("PastePlainText");
		menuItem.setText(s != null ? s : Resource.get("Page_java_zhantiechunwenben"));
		menu.add(menuItem);
		editor.addEnabledComponentWhenEditable(menuItem);
		menu.addSeparator();
		...
		menuItem = new JMenuItem((s != null ? s : Resource.get("Modeler_java_sousuo")) + "...");
		...
		menuItem = new JMenuItem(page.getAction(Resource.get("Page_java_youwenjianduru")));
		...
		menuItem = new JMenuItem(page.getAction(Resource.get("FontDialog_java_ziti")));
		s = getInternationalText(Resource.get("FontDialog_java_ziti"));
		menuItem.setText((s != null ? s : Resource.get("FontDialog_java_ziti")) + "...");
		menuItem.setIcon(null);
		menuItem.setMnemonic(KeyEvent.VK_F);
		menu.add(menuItem);
		editor.addEnabledComponentWhenEditable(menuItem);
