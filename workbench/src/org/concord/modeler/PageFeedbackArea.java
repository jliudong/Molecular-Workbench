...
public class PageFeedbackArea extends FeedbackArea implements Embeddable, AutoResizable {
	...
	public void createPopupMenu() {
		...
		JMenuItem mi = new JMenuItem(Resource.get("PageFeedbackArea_java_dingzhiquyu"));
		...
		mi = new JMenuItem(Resource.get("PageFeedbackArea_java_shanchuquyu"));
		mi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		mi = new JMenuItem(Resource.get("PageFeedbackArea_java_fuzhiquyu"));
		mi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
