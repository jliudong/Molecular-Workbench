...
public final class ModelerUtilities {
	...
	public static void init() {
		...
		imageReader = new ImageReader(Resource.get("Page_java_youwenjianduru"), fileChooser, null);
	...
	public static JComboBox createFontSizeComboBox() {
		...
		c.setToolTipText(Resource.get("ModelUtilities_java_zihao"));
	...
	public static JComboBox createFontNameComboBox() {
		...
		c.setToolTipText(Resource.get("TextBoxPanel_java_zitixuanze"));
		FontMetrics fm = c.getFontMetrics(c.getFont());
