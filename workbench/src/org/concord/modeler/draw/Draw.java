...
public abstract class Draw extends PrintableComponent {
	...
	public Draw() {
		...
		Action a = new AbstractAction(Resource.get("Editor_java_jianqie")) {
		...
		a = new AbstractAction(Resource.get("Editor_java_kaobei")) {
			public void actionPerformed(ActionEvent e) {
				copySelectedElement();
			}
		};
		...
		a.putValue(Action.SHORT_DESCRIPTION, Resource.get("Editor_java_kaobei"));
		a.putValue(Action.ACCELERATOR_KEY, System.getProperty("os.name").startsWith("Mac") ? KeyStroke.getKeyStroke(
		...
		a = new AbstractAction(Resource.get("Editor_java_zhantie")) {
			public void actionPerformed(ActionEvent e) {
				pasteElement();
			}
		};
		...
		a.putValue(Action.SHORT_DESCRIPTION, Resource.get("Editor_java_zhantie"));
		a.putValue(Action.ACCELERATOR_KEY, System.getProperty("os.name").startsWith("Mac") ? KeyStroke.getKeyStroke(
	...
	private void createPopupMenu() {
		...
		cutMI.setAction(getActionMap().get(Resource.get("Editor_java_jianqie")));
		s = getInternationalText(Resource.get("Editor_java_jianqie"));
		if (s != null)
			cutMI.setText(s);
		popupMenu.add(cutMI);
		copyMI.setAction(getActionMap().get(Resource.get("Editor_java_kaobei")));
		...
		pasteMI.setAction(getActionMap().get(Resource.get("Editor_java_zhantie")));
