...
public class Navigator {
	...
	public Navigator(Navigable nav) {
		...
		homeAction.putValue(Action.SHORT_DESCRIPTION, Resource.get("Navigator_java_zhuye"));
	...
	class BackAction extends AbstractAction {
		...
		protected void updateState() {
			...
			putValue(SHORT_DESCRIPTION, left.size() <= 1 ? Resource.get("Navigator_java_fanhui") : "Go to "
	...
	class ForwardAction extends AbstractAction {
		...
		protected void updateState() {
			...
			putValue(SHORT_DESCRIPTION, right.empty() ? Resource.get("Navigator_java_qianjin") : "Go to " + right.lastElement());
			putValue("enabled", isEnabled());
		}
