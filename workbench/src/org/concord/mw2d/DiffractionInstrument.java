...
public class DiffractionInstrument extends JPanel {
	...
	public DiffractionInstrument(boolean addCloseButton) {
		...
		scanButton.setToolTipText(Resource.get("DiffractionInstrument_java_chanshengmoshi"));
		...
		lodButton.setToolTipText(Resource.get("DiffractionInstrument_java_gaibianxijie"));
		...
		button.setToolTipText(Resource.get("DiffractionInstrument_java_qianru"));
		...
		button.setToolTipText(Resource.get("DiffractionInstrument_java_sharpen"));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (pattern.getBufferedImage() == null)
					return;
		...
		button.setToolTipText(Resource.get("DiffractionInstrument_java_blur"));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (pattern.getBufferedImage() == null)
					return;
		...
		button.setToolTipText(Resource.get("DiffractionInstrument_java_zengjiaduibidu"));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				contrast(1.1f);
			}
		...
		button.setToolTipText(Resource.get("DiffractionInstrument_java_jianshaoduibidu"));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				contrast(0.9f);
			}
		...
		button.setToolTipText(Resource.get("DiffractionInstrument_java_zengjialiangdu"));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				brighten(1.1f);
			}
		...
		button.setToolTipText(Resource.get("DiffractionInstrument_java_jianxiaoliangdu"));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				brighten(0.9f);
			}
		...
		zoomInButton.setToolTipText(Resource.get("DiffractionInstrument_java_fangdakongjian"));
		...
		zoomOutButton.setToolTipText(Resource.get("DiffractionInstrument_java_suoxiaokongjian"));
		...
		if (!Page.isApplet()) {
			...
			button.setToolTipText(Resource.get("JmolMenuBar_java_kuaizhao"));
			button.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (model != null)
			...
			button.setText(null);
			button.setToolTipText(Resource.get("DiffractionInstrument_java_baocuntuxiang"));
			p.add(button);
		}
