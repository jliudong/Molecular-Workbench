...
public final class UserAction {
	...
	static {
		...
		description.put(i, s != null ? s : Resource.get("UserAction_java_jiazhixian"));
		longDescription.put(i, "<html><p><b><i>"+Resource.get("UserAction_java_jiazhixian")+"</i></b></p></html>");
	}
	...
	static {
		...
		description.put(i, s != null ? s : Resource.get("UserAction_java_jiafangkuang"));
		longDescription.put(i, "<html><p><b><i>"+Resource.get("UserAction_java_jiafangkuang")+"</i></b></p></html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		icon.put(i, IconPool.getIcon(Resource.get("Editor_java_kaobei")));
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
		description.put(i, Resource.get("UserAction_java_tuodongwanbiaomian"));
		longDescription
				.put(
						i,
						"<html><p><b><i>"+Resource.get("UserAction_java_tuodongwanbiaomian")+"</i></b></p><p>A curved molecular surface is the closed solid shape with curved border.</p></html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
		description.put(i, Resource.get("UserAction_java_tuodongwandai"));
		longDescription.put(i, "<html><p><b><i>"+Resource.get("UserAction_java_tuodongwandai")+"</i></b></p></html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
		description.put(i, Resource.get("UserAction_java_tuodongyuanbiaomian"));
		longDescription.put(i, "<html><p><b><i>"+Resource.get("UserAction_java_tuodongyuanbiaomian")+"</i></b></p></html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
		description.put(i, Resource.get("UserAction_java_tuodongyuandai"));
		longDescription.put(i, "<html><p><b><i>"+Resource.get("UserAction_java_tuodongyuandai")+"</i></b></p></html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
		description.put(i, Resource.get("UserAction_java_tuodong"));
		longDescription.put(i, "<html><p><b><i>"+Resource.get("UserAction_java_tuodong")+"</i></b></p></html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
		description.put(i, Resource.get("UserAction_java_tuodongdai"));
		longDescription.put(i, "<html><p><b><i>"+Resource.get("UserAction_java_tuodongdai")+"</i></b></p></html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
		description.put(i, Resource.get("UserAction_java_ziyoutuodong"));
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		description.put(i, Resource.get("UserAction_java_taijiaduotai"));
		longDescription
				.put(
						i,
						"<html><p><b><i>"+Resource.get("UserAction_java_taijiaduotai")+"</i></b></p><p>The newly added amino acid will be attached to one of the two terminals, whichever is closer to the clicked point.</html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		description.put(i, Resource.get("UserAction_java_jianquduotai"));
		longDescription
				.put(
						i,
						"<html><p><b><i>"+Resource.get("UserAction_java_jianquduotai")+"</i></b></p><p>An amino acid will be detached from one of the two terminals, whichever is closer to the clicked point.</html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		description.put(i, "DNA"+Resource.get("UserAction_java_jianhesuan"));
		longDescription
				.put(
						i,
						"<html><p><b><i>DNA"+Resource.get("UserAction_java_jianhesuan")+"</i></b></p><p>The newly added nucleotide will be attached to whichever end is closer to the clicked point.</html>");
	}
	...
	static {
		...
		cursor.put(i, Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		description.put(i, "DNA"+Resource.get("UserAction_java_jianquhesuan"));
		longDescription
				.put(
						i,
						"<html><p><b><i>DNA"+Resource.get("UserAction_java_jianquhesuan")+"</i></b></p><p>A nucleotide will be detached from whichever end is closer to the clicked point.</html>");
	}
