...
class SnapshotAction extends AbstractAction {
	...
	SnapshotAction(MDModel model, boolean withDescription) {
		...
		putValue(NAME, withDescription ? Resource.get("JmolMenuBar_java_kuaizhao") : "Take a Snapshot Without Description");
		putValue(SHORT_DESCRIPTION, withDescription ? Resource.get("JmolMenuBar_java_kuaizhao") : "Take a snapshot without description");
