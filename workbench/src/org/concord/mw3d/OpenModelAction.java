...
class OpenModelAction extends AbstractAction {
	...
	OpenModelAction(MolecularContainer c) {
		super();
		container = c;
		putValue(NAME, Resource.get("StructureReader_java_dakaimoxing"));
		putValue(SHORT_DESCRIPTION, Resource.get("StructureReader_java_dakaimoxing"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		container.fileChooser.setDialogTitle(s != null ? s : Resource.get("StructureReader_java_dakaimoxing"));
