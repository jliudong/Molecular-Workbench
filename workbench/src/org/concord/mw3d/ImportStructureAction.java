...
class ImportStructureAction extends AbstractAction {
	...
	ImportStructureAction(MolecularContainer c) {
		super();
		container = c;
		putValue(NAME, Resource.get("ImportStructureAction_java_daoru"));
		putValue(SHORT_DESCRIPTION, Resource.get("ImportStructureAction_java_daoru"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		container.fileChooser.setDialogTitle(s != null ? s : Resource.get("ImportStructureAction_java_daoru"));
