...
class DefaultPopupMenu extends JPopupMenu {
	...
	DefaultPopupMenu(MolecularContainer c) {
		...
		miPaste = new JMenuItem(container.view.getActionMap().get(Resource.get("Editor_java_zhantie")));
		miPaste.setEnabled(false);
		String s = MolecularContainer.getInternationalText(Resource.get("Editor_java_zhantie"));
		if (s != null)
			miPaste.setText(s);
		add(miPaste);
		addSeparator();

		JMenuItem mi = new JMenuItem(container.view.getActionMap().get(Resource.get("StructureReader_java_dakaimoxing")));
		...
		mi = new JMenuItem(container.view.getActionMap().get(Resource.get("MolecularContainer_java_xuanze")));
		...
		mi = new JMenuItem(container.view.getActionMap().get(Resource.get("JobTable_java_rewuguanliqi")));
