...
public class MolecularView extends Draw {
	...
	public MolecularView() {
		...
		a.putValue(Action.NAME, Resource.get("Editor_java_jianqie"));
		...
		a.putValue(Action.ACCELERATOR_KEY, System.getProperty("os.name").startsWith("Mac") ? KeyStroke.getKeyStroke(
				...
				true));
		getInputMap().put((KeyStroke) a.getValue(Action.ACCELERATOR_KEY), Resource.get("Editor_java_jianqie"));
		getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_DELETE, 0, true), Resource.get("Editor_java_jianqie"));
		getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_BACK_SPACE, 0, true), Resource.get("Editor_java_jianqie"));
		getActionMap().put(Resource.get("Editor_java_jianqie"), a);
		...
		a.putValue(Action.NAME, Resource.get("Editor_java_kaobei"));
		a.putValue(Action.SMALL_ICON, IconPool.getIcon(Resource.get("Editor_java_kaobei")));
		...
		a.putValue(Action.ACCELERATOR_KEY, System.getProperty("os.name").startsWith("Mac") ? KeyStroke.getKeyStroke(
				...
				true));
		getInputMap().put((KeyStroke) a.getValue(Action.ACCELERATOR_KEY), Resource.get("Editor_java_kaobei"));
		getActionMap().put(Resource.get("Editor_java_kaobei"), a);
		...
		a.putValue(Action.NAME, Resource.get("Editor_java_zhantie"));
		...
		a.putValue(Action.ACCELERATOR_KEY, System.getProperty("os.name").startsWith("Mac") ? KeyStroke.getKeyStroke(
				...
				true));
		getInputMap().put((KeyStroke) a.getValue(Action.ACCELERATOR_KEY), Resource.get("Editor_java_zhantie"));
		getActionMap().put(Resource.get("Editor_java_zhantie"), a);
		...
		a.putValue(Action.NAME, Resource.get("MolecularContainer_java_xuanze"));
		...
		a.putValue(Action.SHORT_DESCRIPTION, Resource.get("MolecularContainer_java_xuanze"));
		a.putValue(Action.ACCELERATOR_KEY, System.getProperty("os.name").startsWith("Mac") ? KeyStroke.getKeyStroke(
				KeyEvent.VK_I, KeyEvent.META_MASK, true) : KeyStroke.getKeyStroke(KeyEvent.VK_I, KeyEvent.CTRL_MASK,
				true));
		getInputMap().put((KeyStroke) a.getValue(Action.ACCELERATOR_KEY), Resource.get("MolecularContainer_java_xuanze"));
		getActionMap().put(Resource.get("MolecularContainer_java_xuanze"), a);
	...
	public void setVisible(Atom a, boolean b) {
		viewer.setAtomVisibility(a.getIndex(), b);
	}

	public void setVisible(RBond rb, boolean b) {
