...
class ExportStructureAction extends AbstractAction {
	...
	ExportStructureAction(MolecularContainer c) {
		super();
		container = c;
		putValue(NAME, Resource.get("ImportStructureAction_java_daochu"));
		putValue(SHORT_DESCRIPTION, Resource.get("ImportStructureAction_java_daochu"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		container.fileChooser.setDialogTitle(s != null ? s : Resource.get("ImportStructureAction_java_daochu"));
