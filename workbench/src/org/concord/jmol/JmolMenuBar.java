...
class JmolMenuBar extends JMenuBar {
	...
	private JMenu createFileMenu() {
		...
		menuItem.setToolTipText(Resource.get("JmolMenuBar_java_dakaiyuancheng"));
	...
	private JMenu createAnimationMenu() {
		...
		final JMenuItem miNonstop = new JMenuItem(s != null ? s : Resource.get("BottomBar_java_meiyouzanting"));
