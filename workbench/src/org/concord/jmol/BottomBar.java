...
class BottomBar extends JPanel implements NavigationListener {
	...
	BottomBar(JmolContainer c) {
		...
		toFirstButton.setToolTipText(Resource.get("BottomBar_java_huidao"));
		...
		toPreviousButton.setToolTipText(Resource.get("BottomBar_java_shangyige"));
		...
		toNextButton.setToolTipText(Resource.get("BottomBar_java_xiayige"));
		...
		nonstopButton.setToolTipText(Resource.get("BottomBar_java_meiyouzanting"));
		...
		toLastButton.setToolTipText(Resource.get("BottomBar_java_zuihouyige"));
		...
		landButton.setToolTipText(Resource.get("BottomBar_java_zantingxiayige"));
